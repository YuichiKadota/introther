...
- webフレームワーク：echo → [Go の echo ってWebサーバーでサクッと REST しちゃう](https://qiita.com/ezaki/items/62e806ae42828bb3567a)
- aws系ライブラリ： [aws/aws-sdk-go](https://github.com/aws/aws-sdk-go)
- バリデーター：[Go言語のバリデーションチェックライブラリ(ozzo-validation)を分かりやすくまとめてみた](https://qiita.com/gold-kou/items/201a19d9d0c760cc2104)
